    ...
    private void Register(){
        ...
        voidCall.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(RegisterEmployeeActivity.this,"You success",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<Void> call, Throwable t) {
                ...
                Toast.makeText(RegisterEmployeeActivity.this,"You Not Success",Toast.LENGTH_SHORT).show();
            }
        });
    }
}
